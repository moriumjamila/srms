...
<div class="box-card">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="NewRegistration" role="tabpanel" aria-labelledby="profile-tab">
            <form method="get" action="<?= base_url('semester_registration') ?>">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <table class="table table-hover m-b-0 c_list">
                                <tbody>
                                    ...
                                    foreach ($semester_subjects as $value) {
                                        ?>
                                        <tr>
                                            <td><input class="big checkbox" type="checkbox" name="subject_id[]" value="<?= $value->sub_id ?>"></td>
