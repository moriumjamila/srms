    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <form method="POST" action="<?= base_url('common/data_update') ?>" name="getformdata">
                <div class="row mb-3">
                    <input type="hidden" name="task_type" value="student">
            ...
            <form method="POST" action="<?= base_url('common/photo_update') ?>" enctype="multipart/form-data">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        ...
                        <?php } else { ?>
                            <img src='<?= base_url($myprofile->photo) ?>' style="width:100px;height:100px;" alt="">
                        <?php } ?>
                    </div>
                </div><br>
                <center>
...
<script>
    ...
    document.forms['getformdata'].elements['session'].value = '<?= $myprofile_acads->session ?>';
    document.forms['getformdata'].elements['semester'].value = '<?= $myprofile_acads->semester ?>';
    document.forms['getformdata'].elements['section'].value = '<?= $myprofile_acads->section ?>';
    document.forms['getformdata2'].elements['status'].value = '<?= $myprofile->status ?>';
</script>
<script>
    function getimageData(input) {
        ...
        document.getElementById('set_image_data').value = 'change';
    }
</script>
<script>
